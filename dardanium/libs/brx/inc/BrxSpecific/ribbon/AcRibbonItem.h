...
public:
    ...
    void text(AcString& acText) const; //deprecated
    AcString text() const;

    void setId(const ACHAR* id);
    void id(AcString& acName) const; //deprecated
    AcString id() const;

    void setImagePath(const ACHAR* acImgPath);
    void imagePath(AcString& acImgPath) const; //deprecated
    AcString imagePath() const;
    ...
    void toolTip(AcString& acToolTip) const; //deprecated
    AcString toolTip() const;
