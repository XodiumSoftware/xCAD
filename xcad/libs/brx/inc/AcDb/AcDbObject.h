...
public:
    ...
    virtual Acad::ErrorStatus addPersistentReactor(AcDbObjectId);
    ...
    Acad::ErrorStatus addReactor(AcDbObjectReactor*) const;
    ...
    Acad::ErrorStatus removeReactor(AcDbObjectReactor*) const;
