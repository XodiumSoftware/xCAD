...
/*--- Module creation code ---*/
...
#else
#if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("bfc", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  Py_XINCREF(__pyx_m);
#else
...
#if PY_MAJOR_VERSION >= 3
  {
    ...
    {
      if (unlikely(PyDict_SetItemString(modules, "bfc", __pyx_m) < 0))
        __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
#endif
...
/*--- Execution code ---*/
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_types, __pyx_t_1, -1);
  if (unlikely(!__pyx_t_2))
    __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1);
  __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_CodeType);
  if (unlikely(!__pyx_t_1))
    __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_CodeType, __pyx_t_1) < 0)
    __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1);
  __pyx_t_1 = 0;
