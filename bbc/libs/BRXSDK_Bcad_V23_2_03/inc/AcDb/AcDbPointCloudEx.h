...
public:
    ...
    Acad::ErrorStatus getCustomOsnapInfo(PointCloudOSnapMode, const AcGePoint3d&, const AcGePoint3d&, const AcGeMatrix3d&, AcArray<AcGePoint3d>&);
    ...
    bool  getPlaneOrPointAt(const AcGeMatrix3d&, const AcGePoint3d&, AcArray<AcGePoint3d>&);
    ...
    Acad::ErrorStatus getPointDataByPrecision(IAcDbPointCloudDataBuffer*&, double, IAcDbPointCloudSpatialFilter* = NULL,
        IAcDbPointCloudAttributeFilter* = NULL, Adesk::UInt32 = 0, Adesk::UInt32 = 1000000uLL) const;
    Acad::ErrorStatus getEstimatedPointCountByPrecision(unsigned long long&, double, IAcDbPointCloudSpatialFilter* = NULL, IAcDbPointCloudAttributeFilter* = NULL) const;
    ...
    Acad::ErrorStatus  getPointDataByPointCount(IAcDbPointCloudDataBuffer*&, Adesk::UInt32, const AcArray<AcString>&, IAcDbPointCloudSpatialFilter*,
        IAcDbPointCloudAttributeFilter*, Adesk::UInt32, Adesk::UInt32) const;
    Acad::ErrorStatus  traverseAllPointData(IAcDbPointCloudPointProcessor*, IAcDbPointCloudSpatialFilter*, Adesk::UInt32, int, const AcArray<AcString>&) const;
