...
public:
    ...
    virtual bool RenderToImage(Atil::Image*,AcGiDrawable*,void*,const AcGsDCRect&,bool = false) = 0;
    ...
    virtual void freezeLayer(LONG_PTR) = 0;
    ...
    virtual void show() = 0;
    virtual void thawLayer(LONG_PTR) = 0;
    ...
    virtual EnableIRResult beginInteractiveRender(void*) = 0;
