    ...
    class MechanicalComponents
    {
        ...
        static public void RetrieveComponentName()
        {
            ...
            using (tr)
            {
                ...
                ComponentInstance componentInstance = ComponentInstance.GetComponentInstance(id);
                ...
                ComponentDefinition componentDefinition = ComponentDefinition.GetComponentDefinition(componentInstance.InstanceBlockId, false);
                ...
                uint compType = componentDefinition.ComponentType;
