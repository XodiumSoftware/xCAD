...
call C:\msys64\msys2_shell.cmd -mingw64 -no-start -defterm -exec="pacman -Q mingw-w64-ucrt-x86_64-gcc"
if errorlevel 1 (
    echo Installing mingw-w64-ucrt-x86_64-gcc...
    call C:\msys64\msys2_shell.cmd -mingw64 -no-start -defterm -exec="pacman -S mingw-w64-ucrt-x86_64-gcc"
