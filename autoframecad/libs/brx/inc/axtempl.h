...
#include "AcGi/AcGiEdgeStyle.h"
  ...
  #include "COM/IAcadBaseDatabaseImpl.h"
  #include "COM/IRetrieveApplicationImpl.h"
  #include "COM/IAcadObjectDispatchImpl.h"
  #include "COM/IAcadEntityDispatchImpl.h"
  #include "COM/IOPMPropertyExtensionImpl.h"
  #include "COM/IOPMPropertyExtensionImpl2.h"
  #include "COM/IAcPiCategorizePropertiesImpl.h"
  #include "COM/IAcPiPropertyDisplayImpl.h"
#endif // _WIN32
