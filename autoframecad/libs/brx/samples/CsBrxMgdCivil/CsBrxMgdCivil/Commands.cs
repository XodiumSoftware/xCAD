...
namespace CsBrxMgdCivil
{
    ...
    public class Commands : IExtensionApplication
    {
        ...
        // GIS creation
        [CommandMethod("samp_GISWorkflow")]
        static public void sampGISWorkflow()
        {
            GisSample.do_GISWorkflow();
        }

        // Point workflow
        [CommandMethod("samp_PointWorkflow")]
        static public void sampPointWorkflow()
        {
            PointSample.do_PointWorkflow();
        }
    }
}
