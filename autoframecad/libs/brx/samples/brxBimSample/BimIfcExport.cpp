...
void IfcExportReactorInstance::assignCustomProperties(Context& context, const Ice::IfcApi::Entity& ent)
{
    ...
    Ice::IfcApi::Entity prop3 = createMeasureValueProperty(context, L"MeasureValue", 150.1415926000000, Ice::IfcApi::IfcPositiveLengthMeasure, scm);
...
Ice::IfcApi::Entity IfcExportReactorInstance::createMeasureValueProperty(Context & context, ACHAR * propName, double value, const char* propTag, Ice::EIfcSchemaId scm)
{
    Ice::IfcApi::SelectValue propValue(Ice::IfcApi::IfcValue, scm);
    Ice::IfcApi::SelectValue measureValue(Ice::IfcApi::IfcMeasureValue, scm);
    Ice::IfcApi::Result res = measureValue.setValue(propTag, value);
    assert(Ice::IfcApi::Result::eOk == res);
    res = propValue.setValue(Ice::IfcApi::IfcMeasureValue, std::move(measureValue));
    assert(Ice::IfcApi::Result::eOk == res);

    Ice::IfcApi::Entity singleValue = Ice::IfcApi::Entity::create(*context.ifcModel(), Ice::IfcApi::IfcPropertySingleValue);
    res = singleValue.setAttribute(Ice::IfcApi::Name, Ice::IfcApi::String(propName));
    assert(Ice::IfcApi::Result::eOk == res);
    res = singleValue.setAttribute(Ice::IfcApi::NominalValue, propValue);
    assert(Ice::IfcApi::Result::eOk == res);
