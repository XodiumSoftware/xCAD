...
namespace EventsWatcher
{
	...
	public class Output : System.Windows.Forms.Form
	{
		...
		private void Output_Load(object sender, System.EventArgs e)
		{
			...
			this.richTextBox1.ContextMenuStrip = cm;

			//Add File Menu
			cm.Items.Add(new ToolStripMenuItem("&Save...",null, new EventHandler(this.FileSave_Clicked), (Keys)Shortcut.CtrlS));
			cm.Items.Add("-");
			cm.Items.Add(new ToolStripMenuItem("&Clean", null, new EventHandler(this.Clean_Clicked), (Keys)Shortcut.CtrlC));
		}
