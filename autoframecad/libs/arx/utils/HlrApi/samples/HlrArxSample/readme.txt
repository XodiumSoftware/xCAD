...
This sample demonstrates the use of AsdkHlrApi25.

The AsdkHlrApi25 module is there to help to calculate hidden lines 
...
To use these applications, AsdkHlrApi25.dbx should be copied into the 
AutoCAD folder. First the OS must find it and second AutoCAD must find 
it for the acrxLoadModule("AsdkHlrApi25.dbx",0) call to succeed.
