...
To run the sample:
	...
	Copy the Tool1.bmp, SimpleToolPaletteExample.dll, SimpleToolPaletteExample.comhost.dll and 
	SimpleToolPaletteExample.runtimeconfig.json files to the AutoCAD installation folder.
