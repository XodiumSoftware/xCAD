    ...
    ComponentsFilter::getKeyPropertyFilter(const AcString &keyProperty)
    {
        ...
        case EComponentProperty::eBOMStatus:
        {
            filterFunction = [](const AcDbObjectId &objId)
            {
                ...
                {
                case EBrxStatusBOM::eRegular:
                    return _ACRX_T("Regular");
                case EBrxStatusBOM::eTransparent:
                    return _ACRX_T("Transparent");
                case EBrxStatusBOM::eTerminal:
                    return _ACRX_T("Terminal");
                case EBrxStatusBOM::eExcluded:
                    return _ACRX_T("Excluded");
                default:
                    return _ACRX_T("");
                };
            };
